...
PROMPT_PDF2TXT = """
你是一位专业的文档排版专家。请帮我处理以下OCR识别的内容：

{}

要求：
1. 重新排版内容为markdown格式
2. 通读上下文，修正明显的OCR识别错误，例如明显语义错误，缺字错字，明显的层级错误等
3. 删掉所有的“让生命放，让资源流动” 或 “序让生命放，让资源流动” 这句话

使用json输出，输出格式：
{{
    "formatted_content": "优化后的markdown格式内容",
    "corrections":  "原文错误内容修正原因说明"
}}
